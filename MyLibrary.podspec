...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/haitaowu/MyLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'haitaowu' => 'woxiaotao521@126.com' }
  s.source           = { :git => 'https://github.com/haitaowu/MyLibrary.git', :tag => s.version.to_s }
